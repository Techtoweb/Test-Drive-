...
// All 246 pages corresponding exactly to the OCR from the provided PDF
const pages = [
  // Page 1
  {
    pageNumber: 1,
...
সাতটি ক্লিক। ঢাকার কোনো সোফায় আরাম করে বসে থাকা একজন মানুষ, ডালাসের কোনো ব্যস্ত পেশাজীবী, কিংবা ডুসেলডর্ফের কোনো সাধারণ ক্রেতা—সামাজিক যোগাযোগমাধ্যমে চোখ বুলাতে বুলাতে হঠাৎ কোনো পণ্যের প্রতি আগ্রহী হয়ে ওঠা থেকে শুরু করে দরজায় পৌঁছে যাওয়া একটি পেইড অর্ডার সম্পন্ন করতে গড়ে যতগুলো ট্যাপ প্রয়োজন, সেটিই সাতটি ক্লিক।
...
// Read from build script to output the file
console.log("Adding comprehensive pages...");
